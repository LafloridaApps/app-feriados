...
import PaginaCalendarioAusenciasMobile from './PaginaCalendarioAusenciasMobile'; // Importar el componente móvil
import CalendarioDashboard from './CalendarioDashboard';
import ModalDetalleFuncionario from './ModalDetalleFuncionario';
import './PaginaCalendarioAusencias.css'; // Importar el archivo CSS personalizado
...
const PaginaCalendarioAusencias = () => {
    ...
    return (
        <div className="dashboard-container">
            ...
            {!loading && !error && (
                isMobile ? (
                    <PaginaCalendarioAusenciasMobile
                        mesActual={mesActual}
                        ausencias={ausencias}
...
export default PaginaCalendarioAusencias;